...
option = st.selectbox(
   "",
   ("La Durance à Meyrargues", "La Durance à Saint-Paul-les-Durance","Le Gapeau à Hyeres", "Le Verdon à Vinon-sur-Verdon", 'La Durance à Embrun'),
...
df = pd.read_csv(f'stations_bis/{option}/debit.csv')
